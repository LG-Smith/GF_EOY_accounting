...
-- AWA 11.02.21 switch to match on vtrserno instead of link1 to accomodate PSS data 
INSERT /*+ APPEND*/ INTO hadd_final_gb
WITH cams_frame AS (
SELECT distinct
  ck.fishing_year
  ,ck.id
